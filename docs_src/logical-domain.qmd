...
This page contains the **ER diagram** "Entity Relation Diagram" use to describe all the relations between the entities in a data base.
In this case it shows a simplest abd logical banking domain with the following entities:
 - Customer
 - Account
 - Transactions
 - Loans
